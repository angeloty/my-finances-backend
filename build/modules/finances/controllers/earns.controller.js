...
var EarnsController = /** @class */ (function (_super) {
    ...
    function EarnsController() {
        ...
        _this.service = new earns_service_1.EarnsService();
        return _this;
    }
    EarnsController.prototype.all = function (request, response, next) {
    ...
    EarnsController.prototype.some = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var element, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EarnsController.prototype.add = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var saved, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EarnsController.prototype.update = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var saved, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EarnsController.prototype.remove = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var deleted, e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ], EarnsController.prototype, "all", null);
    __decorate([
        route_decorator_1.Get({ path: ':id', secured: true }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], EarnsController.prototype, "some", null);
    __decorate([
        route_decorator_1.Post({ path: '', secured: true }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], EarnsController.prototype, "add", null);
    __decorate([
        route_decorator_1.Put({ path: ':id', secured: true }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], EarnsController.prototype, "update", null);
    __decorate([
        route_decorator_1.Delete({ path: ':id', secured: true }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], EarnsController.prototype, "remove", null);
