...
var EarnsService = /** @class */ (function () {
    function EarnsService() {
        ...
        this.create = function (test) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.repository.save(this.repository.merge(new earns_model_1.EarnModel(), test))];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        e_3 = _a.sent();
                        throw e_3;
        ...
        this.repository = application_context_1.default.connection.getRepository(earns_model_1.EarnModel);
    }
    return EarnsService;
}());
