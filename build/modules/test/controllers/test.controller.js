...
var TestController = /** @class */ (function (_super) {
    ...
    function TestController() {
        ...
        _this.service = new test_service_1.TestService();
        return _this;
    }
    TestController.prototype.all = function (request, response, next) {
    ...
    TestController.prototype.some = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var element, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TestController.prototype.add = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var saved, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TestController.prototype.test = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var saved, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TestController.prototype.remove = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var deleted, e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        route_decorator_1.Get({ path: 'test' }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], TestController.prototype, "all", null);
    __decorate([
        route_decorator_1.Get({ path: 'test/:id' }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], TestController.prototype, "some", null);
    __decorate([
        route_decorator_1.Post({ path: 'test' }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], TestController.prototype, "add", null);
    __decorate([
        route_decorator_1.Put({ path: 'test/:id' }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], TestController.prototype, "test", null);
    __decorate([
        route_decorator_1.Delete({ path: 'test/:id' }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
