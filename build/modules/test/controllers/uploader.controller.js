...
var UploaderController = /** @class */ (function (_super) {
    ...
    UploaderController.prototype.add = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.uploadFile('file', request)];
                    case 1:
                        files = _a.sent();
                        return [2 /*return*/, response
                                .status(201)
                                .send(files.map(function (f) { return f.filename; }))];
                    case 2:
                        e_1 = _a.sent();
    ...
    ], UploaderController.prototype, "add", null);
    UploaderController = __decorate([
        controller_decorator_1.Controller({ path: 'uploader' }),
